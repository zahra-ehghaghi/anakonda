...
ARG GIT_COMMITE=None GIT_BRANCH=None GIT_TAG=None BUILD_ID=None BUILD_TAG=None
LABEL GIT_COMMITE=$GIT_COMMITE  GIT_BRANCH=$GIT_BRANCH BUILD_TAG=$BUILD_TAG BUILD_ID=$BUILD_ID GIT_TAG=$GIT_TAG
