...
ARG GIT_COMMITE=None GIT_BRANCH=None BUILD_TAG=None BUILD_ID=None
LABEL GIT_COMMITE=$GIT_COMMITE  GIT_BRANCH=$GIT_BRANCH BUILD_TAG=$BUILD_TAG BUILD_ID=$BUILD_ID
